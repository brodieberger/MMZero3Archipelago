...
item_data_table: Dict[str, MMZero3ItemData] = {
    ...
    "Secret Disk 111: Omega": MMZero3ItemData(code=111, type=ItemClassification.filler),
    "Secret Disk 112: Deathtanz Mantisk": MMZero3ItemData(code=112, type=ItemClassification.filler),
    "Secret Disk 113: Childre Inarabitta": MMZero3ItemData(code=113, type=ItemClassification.filler),
    "Secret Disk 114: Blazin' Flizard": MMZero3ItemData(code=114, type=ItemClassification.filler),
    "Secret Disk 115: Hellbat Schilt": MMZero3ItemData(code=115, type=ItemClassification.filler),
    "Secret Disk 117: Prea": MMZero3ItemData(code=117, type=ItemClassification.filler),
    "Secret Disk 118: Anubis Necromancess V": MMZero3ItemData(code=118, type=ItemClassification.filler),
    "Secret Disk 119: Hanumachine R": MMZero3ItemData(code=119, type=ItemClassification.filler),
    "Secret Disk 120: Blizzack Stagroff R": MMZero3ItemData(code=120, type=ItemClassification.filler),
    "Secret Disk 121: Copy X Mark II": MMZero3ItemData(code=121, type=ItemClassification.filler),
    "Secret Disk 122: Tretista Kelverian": MMZero3ItemData(code=122, type=ItemClassification.filler),
    "Secret Disk 123: Glacier Le Cactank": MMZero3ItemData(code=123, type=ItemClassification.filler),
    "Secret Disk 124: Cubit Foxtar": MMZero3ItemData(code=124, type=ItemClassification.filler),
    "Secret Disk 125: Volteel Biblio": MMZero3ItemData(code=125, type=ItemClassification.filler),
    "Secret Disk 126: Pantheon Hunter": MMZero3ItemData(code=126, type=ItemClassification.filler),
    "Secret Disk 127: Pantheon Guardian": MMZero3ItemData(code=127, type=ItemClassification.filler),
    "Secret Disk 128: Pantheon Aqua": MMZero3ItemData(code=128, type=ItemClassification.filler),
    "Secret Disk 129: Pantheon Fist": MMZero3ItemData(code=129, type=ItemClassification.filler),
    "Secret Disk 130: Pantheon Base": MMZero3ItemData(code=130, type=ItemClassification.filler),
    "Secret Disk 131: Deathlock": MMZero3ItemData(code=131, type=ItemClassification.filler),
    "Secret Disk 132: Gyro Cannon": MMZero3ItemData(code=132, type=ItemClassification.filler),
    "Secret Disk 133: Grand Cannon": MMZero3ItemData(code=133, type=ItemClassification.filler),
    "Secret Disk 134: Tile Cannon": MMZero3ItemData(code=134, type=ItemClassification.filler),
    "Secret Disk 135: Pillar Cannon": MMZero3ItemData(code=135, type=ItemClassification.filler),
    "Secret Disk 136: Heavy Cannon": MMZero3ItemData(code=136, type=ItemClassification.filler),
    "Secret Disk 137: Capsule Cannon": MMZero3ItemData(code=137, type=ItemClassification.filler),
    "Secret Disk 138: Generator Cannon": MMZero3ItemData(code=138, type=ItemClassification.filler),
    "Secret Disk 139: Eye Cannon": MMZero3ItemData(code=139, type=ItemClassification.filler),
    "Secret Disk 140: Shrimpolin": MMZero3ItemData(code=140, type=ItemClassification.filler),
    "Secret Disk 141: Volcaire": MMZero3ItemData(code=141, type=ItemClassification.filler),
    "Secret Disk 142: Claveker": MMZero3ItemData(code=142, type=ItemClassification.filler),
    "Secret Disk 143: Petatria": MMZero3ItemData(code=143, type=ItemClassification.filler),
    "Secret Disk 144: Shotloid": MMZero3ItemData(code=144, type=ItemClassification.filler),
    "Secret Disk 145: Seimeran": MMZero3ItemData(code=145, type=ItemClassification.filler),
    "Secret Disk 146: Lamplort": MMZero3ItemData(code=146, type=ItemClassification.filler),
    "Secret Disk 147: Lemmingles": MMZero3ItemData(code=147, type=ItemClassification.filler),
    "Secret Disk 148: Cattatank": MMZero3ItemData(code=148, type=ItemClassification.filler),
    "Secret Disk 149: Top Gabyoall": MMZero3ItemData(code=149, type=ItemClassification.filler),
    "Secret Disk 150: Snakecord": MMZero3ItemData(code=150, type=ItemClassification.filler),
    "Secret Disk 151: Gallisni": MMZero3ItemData(code=151, type=ItemClassification.filler),
    "Secret Disk 152: Crossbyne": MMZero3ItemData(code=152, type=ItemClassification.filler),
    "Secret Disk 153: Flopper": MMZero3ItemData(code=153, type=ItemClassification.filler),
    "Secret Disk 154: PurpleNerple": MMZero3ItemData(code=154, type=ItemClassification.filler),
    "Secret Disk 155: Mothjiro": MMZero3ItemData(code=155, type=ItemClassification.filler),
    "Secret Disk 156: Batring": MMZero3ItemData(code=156, type=ItemClassification.filler),
    "Secret Disk 157: Mellnet": MMZero3ItemData(code=157, type=ItemClassification.filler),
    "Secret Disk 158: Shotcounter": MMZero3ItemData(code=158, type=ItemClassification.filler),
    "Secret Disk 159: Sharkseal X": MMZero3ItemData(code=159, type=ItemClassification.filler),
    "Secret Disk 160: Shelluno": MMZero3ItemData(code=160, type=ItemClassification.filler),
    "Secret Disk 161: Icebon": MMZero3ItemData(code=161, type=ItemClassification.filler),
    "Secret Disk 162: Shellcrawler": MMZero3ItemData(code=162, type=ItemClassification.filler),
    "Secret Disk 163: Cannonhopper": MMZero3ItemData(code=163, type=ItemClassification.filler),
    "Secret Disk 164: Weil": MMZero3ItemData(code=164, type=ItemClassification.filler),
    "Secret Disk 177: Harpuia": MMZero3ItemData(code=177, type=ItemClassification.filler),
    "Secret Disk 178: Fefnir": MMZero3ItemData(code=178, type=ItemClassification.filler),
    "Secret Disk 179: Leviathan": MMZero3ItemData(code=179, type=ItemClassification.filler),
    "Secret Disk 180: Phantom": MMZero3ItemData(code=180, type=ItemClassification.filler),
